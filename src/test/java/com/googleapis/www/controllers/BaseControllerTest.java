...
import com.googleapis.www.testing.HttpCallbackCatcher;
...
public class BaseControllerTest {
     ...
     */
    protected static YoutubeSearchClient createConfigurationFromEnvironment() {
        YoutubeSearchClient.Builder builder = new YoutubeSearchClient.Builder();

        final String environment = System.getenv("YOUTUBE_SEARCH_LIB_ENVIRONMENT");
        final String timeout = System.getenv("YOUTUBE_SEARCH_LIB_TIMEOUT");
     ...
     */
    protected static YoutubeSearchClient createConfiguration() {
        // Set Configuration parameters for test execution
        YoutubeSearchClient config = createConfigurationFromEnvironment();
